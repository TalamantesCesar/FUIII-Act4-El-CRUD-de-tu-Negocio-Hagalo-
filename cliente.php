...
<html lang="en">
    <head>
        <title> Registro Cliente Hagalo</title>
        <meta charset="UTF-8">
                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-4" name="id" placeholder="ID">
                                    <input type="text" class="form-control mb-4" name="dni" placeholder="Dni">
